...
- New files should mimic file structure of the `/dtos` folder (so you can have nested items that have the same placement in all exports). You can already nest folders, but they just export to the first level of the output folder.